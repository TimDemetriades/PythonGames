...
mixer.music.play(-1)    # -1 so the song loops
...
# Game Over Text
game_over_font = pygame.font.Font("freesansbold.ttf", 64)     # font style and size
...
def game_over_text():
    ...
    screen.blit(end_text, (200, 250))   # draws text at middle of screen
